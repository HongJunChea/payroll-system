...
endm
    ...
    MOV EMPLOYEES.pto[0], 300
    MOV EMPLOYEES.has_epf[0], 1
    MOV EMPLOYEES.has_socso[0], 1
    MOV EMPLOYEES.has_eis[0], 1

    MOV SI,OFFSET EMPLOYEES.emp_name[35], John
    MOV EMPLOYEES.job_type[0], 2
    MOV EMPLOYEES.orp[35], 15.0
    MOV EMPLOYEES.pto[35], 200
    MOV EMPLOYEES.has_epf[35], 1
    MOV EMPLOYEES.has_socso[35], 1
    MOV EMPLOYEES.has_eis[35], 1

    MOV SI,OFFSET EMPLOYEES.emp_name[70], Alex
    MOV EMPLOYEES.job_type[0], 1
    MOV EMPLOYEES.orp[70], 8.50
    MOV EMPLOYEES.pto[70], 0
    MOV EMPLOYEES.has_epf[70], 0
    MOV EMPLOYEES.has_socso[70], 0
    MOV EMPLOYEES.has_eis[70], 0
